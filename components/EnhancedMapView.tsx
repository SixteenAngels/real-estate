          ...
          <div>
            ...
            {displayProperty && (
              <p className="text-sm text-muted-foreground">
                {displayProperty.title} • {displayProperty.location}
              </p>
            )}
          </div>
        </div>
        ...
        <div className="flex-1 relative">
          <motion.div
            ...
            className={`w-full h-full ${
              mapType === 'satellite' 
                ...
                : 'bg-gradient-to-br from-blue-50 to-green-50 dark:from-gray-800 dark:to-gray-900'
          ...
          >
            ...
            <div className="absolute inset-0">
              {mapType === 'roadmap' ? (
                <div className="w-full h-full bg-gradient-to-br from-blue-100 via-white to-green-100">
                ...
                <div className="w-full h-full bg-gradient-to-br from-green-800 via-blue-800 to-gray-800 opacity-70">
                  <div className="absolute inset-0 bg-gradient-to-tr from-transparent via-green-400/10 to-blue-400/10"></div>
                </div>
              )}
            </div>
                      ...
                      {(isBooked || isTarget) && (
                        <motion.div
                          className={`absolute -top-2 -right-2 w-4 h-4 rounded-full flex items-center justify-center ${
                            isTarget ? 'bg-primary' : 'bg-green-500'
                          }`}
                          initial={{ scale: 0 }}
                          animate={{ scale: 1 }}
          ...
          {displayProperty && (
            ...
            >
              <Tabs defaultValue="details" className="flex-1 flex flex-col">
                    ...
                    <CardHeader className="pb-3">
                      <div className="flex items-start justify-between">
                        <div>
                          ...
                          <p className="text-sm text-muted-foreground">{displayProperty.location}</p>
                        </div>
                      ...
                      {mode === 'booking-details' && targetBooking && (
                        <div className="bg-green-50 dark:bg-green-950/20 rounded-lg p-3 border border-green-200 dark:border-green-800">
                          <div className="flex items-center space-x-2 mb-2">
                            ...
                            <span className="font-medium text-green-800 dark:text-green-200">Active Booking</span>
                          </div>
                ...
                <TabsContent value="directions" className="flex-1 p-4">
                  {directionsData ? (
                ...
                <TabsContent value="nearby" className="flex-1 p-4">
                  <Card>
                    <CardHeader>
