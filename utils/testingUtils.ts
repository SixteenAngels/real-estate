import { User, Property, Notification, ChatMessage, Booking, Transaction } from '../types';
...
export class TestingUtils {
  ...
  public async runIntegrationTests(): Promise<TestResult[]> {
    ...
    tests.push(...await this.testLocalStorageOperations());
      ...
      await this.testPerformance(
        ...
        () => {
          ...
          properties.forEach(prop => ({
            ...prop,
            displayPrice: `GHS ${prop.price.toLocaleString()}`
          }));
        },
